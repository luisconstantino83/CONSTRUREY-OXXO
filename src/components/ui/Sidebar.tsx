...
import {
  LayoutDashboard, FileText, Flame, BarChart3,
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-3 py-4 border-t border-dark-700">
        ...
        <button onClick={logout}
          className="flex items-center gap-3 px-3 py-2.5 w-full rounded-lg text-sm text-dark-400 hover:text-red-400 hover:bg-red-500/10 transition-all">
          <LogOut size={17} />
          Cerrar sesión
        </button>
      </div>
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 w-9 h-9 bg-dark-800 border border-dark-600 rounded-lg flex items-center justify-center"
      >
